...
const e = {context: void 0, registry: void 0}, t = (e, t) => e === t, r = Symbol("solid-proxy"),
  n = Symbol("solid-track"), i = {equals: t};
let o = P;
const a = 1, l = 2, s = {owned: null, cleanups: null, context: null, owner: null};
var c = null;
let u = null, d = null, h = null, p = null, g = 0;

function f(e, t) {
  const r = d, n = c, i = 0 === e.length, o = void 0 === t ? n : t,
    a = i ? s : {owned: null, cleanups: null, context: o ? o.context : null, owner: o},
    l = i ? e : () => e((() => w((() => H(a)))));
  c = a, d = null;
  try {
    return A(l, !0)
...
function M() {
  if (this.sources && this.state) if (this.state === a) L(this); else {
    const e = h;
    h = null, A((() => $(this)), !1), h = e
  }
  if (d) {
...
function z(e, t, r) {
  ...
  return e.comparator && e.comparator(n, t) || (e.value = t, e.observers && e.observers.length && A((() => {
    for (let t = 0; t < e.observers.length; t += 1) {
      const r = e.observers[t], n = u && u.running;
      n && u.disposed.has(r), (n ? r.tState : r.state) || (r.pure ? h.push(r) : p.push(r), r.observers && F(r)), n || (r.state = a)
    }
...
function L(e) {
  ...
  !function (e, t, r) {
    ...
    try {
      ...
      return e.pure && (e.state = a, e.owned && e.owned.forEach(H), e.owned = null), e.updatedAt = r + 1, E(l)
    } finally {
      d = o, c = i
    }
...
function S(e) {
  ...
  const t = [e];
  for (; (e = e.owner) && (!e.updatedAt || e.updatedAt < g);) e.state && t.push(e);
  for (let r = t.length - 1; r >= 0; r--) if ((e = t[r]).state === a) L(e); else if (e.state === l) {
    const r = h;
...
function F(e) {
  for (let t = 0; t < e.observers.length; t += 1) {
    ...
    r.state || (r.state = l, r.pure ? h.push(r) : p.push(r), r.observers && F(r))
  }
}
...
function H(e) {
  ...
  if (e.sources) for (; e.sources.length;) {
    const t = e.sources.pop(), r = e.sourceSlots.pop(), n = t.observers;
    if (n && n.length) {
      const e = n.pop(), i = t.observerSlots.pop();
...
function j(e) {
  ...
  return y(function (e, t, r = {}) {
    let i = [], o = [], a = [], l = 0, s = t.length > 1 ? [] : null;
    return k((() => O(a))), () => {
      let c, u, d = e() || [];
      return d[n], w((() => {
        let e, t, n, p, g, v, m, b, y, w = d.length;
        if (0 === w) 0 !== l && (O(a), a = [], i = [], o = [], l = 0, s && (s = [])), r.fallback && (i = [N], o[0] = f((e => (a[0] = e, r.fallback()))), l = 1); else if (0 === l) {
...
function I(e) {
  const t = e.keyed, r = y((() => e.when), void 0, {equals: (e, r) => t ? e === r : !e == !r});
  return y((() => {
    const n = r();
    if (n) {
      const i = e.children;
...
function U(e) {
  ...
  const r = x((() => e.children)), n = y((() => {
    ...
    return [-1]
  }), void 0, {equals: (e, r) => (t ? e[1] === r[1] : !e[1] == !r[1]) && e[2] === r[2]});
  return y((() => {
    const [r, i, o] = n();
...
const X = new Set(["className", "value", "readOnly", "formNoValidate", "isMap", "noModule", "playsInline", "allowfullscreen", "async", "autofocus", "autoplay", "checked", "controls", "default", "disabled", "formnovalidate", "hidden", "indeterminate", "inert", "ismap", "loop", "multiple", "muted", "nomodule", "novalidate", "open", "playsinline", "readonly", "required", "reversed", "seamless", "selected"]),
  ...
  q = Object.assign(Object.create(null), {className: "class", htmlFor: "for"}), Y = Object.assign(Object.create(null), {
    class: "className",
...
function se(e, t, r, n, i, o) {
  ...
  if (r === n) return n;
  if ("ref" === t) o || r(e); else if ("on:" === t.slice(0, 3)) {
    const i = t.slice(3);
    ...
    const i = t.slice(2).toLowerCase(), o = Z.has(i);
    if (!o && n) {
      const t = Array.isArray(n) ? n[0] : n;
      e.removeEventListener(i, t)
    }
    (o || r) && (!function (e, t, r, n) {
      if (n) Array.isArray(r) ? (e[`$$${t}`] = r[0], e[`$$${t}Data`] = r[1]) : e[`$$${t}`] = r; else if (Array.isArray(r)) {
        const n = r[0];
        e.addEventListener(t, r[0] = t => n.call(e, r[1], t))
      } else e.addEventListener(t, r)
    }(e, i, r, o), o && ee([i]))
  } else if ("attr:" === t.slice(0, 5)) te(e, t.slice(5), r); else if ((u = "prop:" === t.slice(0, 5)) || (s = G.has(t)) || !i && ((c = function (e, t) {
    const r = Y[e];
    return "object" == typeof r ? r[t] ? r.$ : void 0 : r
  }(t, e.tagName)) || (l = X.has(t))) || (a = e.nodeName.includes("-"))) u && (t = t.slice(5), l = !0), "class" === t || "className" === t ? re(e, r) : !a || l || s ? e[c || t] = r : e[(d = t, d.toLowerCase().replace(/-([a-z])/g, ((e, t) => t.toUpperCase())))] = r; else {
...
function ce(e) {
  ...
  for (e.target !== r && Object.defineProperty(e, "target", {
    configurable: !0,
    value: r
  }), Object.defineProperty(e, "currentTarget", {configurable: !0, get: () => r || document}); r;) {
    const n = r[t];
    if (n && !r.disabled) {
      const i = r[`${t}Data`];
...
function ue(e, t, r, n, i) {
  ...
  if (t === r) return r;
  const o = typeof t, a = void 0 !== n;
  if (e = a && r[0] && r[0].parentNode || e, "string" === o || "number" === o) if ("number" === o && (t = t.toString()), a) {
    let i = r[0];
    i && 3 === i.nodeType ? i.data !== t && (i.data = t) : i = document.createTextNode(t), r = pe(e, r, n, i)
  } else r = "" !== r && "string" == typeof r ? e.firstChild.data = t : e.textContent = t; else if (null == t || "boolean" === o) r = pe(e, r, n); else {
    ...
    if (Array.isArray(t)) {
      ...
      if (0 === o.length) {
        ...
        let n = r.length, i = t.length, o = n, a = 0, l = 0, s = t[i - 1].nextSibling, c = null;
        for (; a < i || l < o;) if (t[a] !== r[l]) {
          for (; t[i - 1] === r[o - 1];) i--, o--;
          if (i === a) {
            const t = o < n ? l ? r[l - 1].nextSibling : r[o - l] : s;
            for (; l < o;) e.insertBefore(r[l++], t)
          } else if (o === l) for (; a < i;) c && c.has(t[a]) || t[a].remove(), a++; else if (t[a] === r[o - 1] && r[l] === t[i - 1]) {
...
function de(e, t, r, n) {
  ...
  for (let o = 0, a = t.length; o < a; o++) {
    let a, l = t[o], s = r && r[o];
    if (null == l || !0 === l || !1 === l) ; else if ("object" == (a = typeof l) && l.nodeType) e.push(l); else if (Array.isArray(l)) i = de(e, l, s) || i; else if ("function" === a) if (n) {
      for (; "function" == typeof l;) l = l();
      i = de(e, Array.isArray(l) ? l : [l], Array.isArray(s) ? s : [s]) || i
    } else e.push(l), i = !0; else {
      const t = String(l);
...
function fe(t) {
  const {useShadow: r} = t, n = document.createTextNode(""), i = c;
  let o;
  return b((() => {
    o || (o = function (e, t) {
      const r = c, n = d;
    ...
    if (e instanceof HTMLHeadElement) {
      ...
      }(t.isSVG ? "g" : "div", t.isSVG), a = r && i.attachShadow ? i.attachShadow({mode: "open"}) : i;
      Object.defineProperty(i, "_$host", {
        get: () => n.parentNode,
        configurable: !0
      }), ae(a, o), e.appendChild(i), t.ref && t.ref(i), k((() => e.removeChild(i)))
    }
  }), void 0, {render: !!!e.context}), n
}

const ve = Symbol("store-raw"), me = Symbol("store-node"), be = Symbol("store-has"), ye = Symbol("store-self");

function we(e) {
  let t = e[r];
  if (!t && (Object.defineProperty(e, r, {value: t = new Proxy(e, ze)}), !Array.isArray(e))) {
    const r = Object.keys(e), n = Object.getOwnPropertyDescriptors(e);
    for (let i = 0, o = r.length; i < o; i++) {
      const o = r[i];
      n[o].get && Object.defineProperty(e, o, {enumerable: n[o].enumerable, get: n[o].get.bind(t)})
    }
  }
  return t
}
...
function ke(e, t = new Set) {
  ...
  if (Array.isArray(e)) {
    ...
    for (let r = 0, o = e.length; r < o; r++) i = e[r], (n = ke(i, t)) !== i && (e[r] = n)
  } else {
    Object.isFrozen(e) ? e = Object.assign({}, e) : t.add(e);
    const r = Object.keys(e), a = Object.getOwnPropertyDescriptors(e);
    for (let l = 0, s = r.length; l < s; l++) o = r[l], a[o].get || (i = e[o], (n = ke(i, t)) !== i && (e[o] = n))
  }
  return e
}
...
function Ce(e, t) {
  let r = e[t];
  return r || Object.defineProperty(e, t, {value: r = Object.create(null)}), r
}

function xe(e, t, r) {
  if (e[t]) return e[t];
  const [n, i] = v(r, {equals: !1, internal: !0});
  return n.$ = i, e[t] = n
}
...
function Se(e, t, r = []) {
  ...
  if (t.length > 1) {
    n = t.shift();
    const o = typeof n, a = Array.isArray(e);
    if (Array.isArray(n)) {
  ...
  let o = t[0];
  "function" == typeof o && (o = o(i, r), o === i) || void 0 === n && null == o || (o = ke(o), void 0 === n || _e(i) && _e(o) && !Array.isArray(o) ? Be(i, o) : Le(e, n, o))
}

function Ae(...[e, t]) {
  const r = ke(e || {}), n = Array.isArray(r);
...
function Te(e, t, r, n, i) {
  ...
  if (a) {
    if (e.length && o.length && (!n || i && e[0] && null != e[0][i])) {
      let t, r, a, l, s, c, u, d;
      for (a = 0, l = Math.min(o.length, e.length); a < l && (o[a] === e[a] || i && o[a] && e[a] && o[a][i] === e[a][i]); a++) Te(e[a], o, a, n, i);
      const h = new Array(e.length), p = new Map;
      ...
      for (r = a; r < e.length; r++) r in h ? (Le(o, r, h[r]), Te(e[r], o, r, n, i)) : Le(o, r, e[r])
...
function $e(e, t = {}) {
  const {merge: r, key: n = "id"} = t, i = ke(e);
  return e => {
    if (!_e(e) || !_e(i)) return i;
    const t = Te(i, {[Pe]: e}, Pe, r, n);
    return void 0 === t ? e : t
  }
}
...
function Ee(e, t) {
  return {id: He(), name: "", color: "performance", content: "performance", size: t, period: e}
}
...
xt.app = "Crypto Bubbles", xt.twitter = "CryptoBubbles", xt.instagram = "cryptobubbles", xt.telegram = "CryptoBubbles", xt.email = "contact@cryptobubbles.net", xt.logo = "/images/logo64.png", xt.playStore = "https://play.google.com/store/apps/details?id=net.cryptobubbles", xt.appStore = "https://apps.apple.com/app/id1599892658", xt.bubblePadding = Math.round(2 * window.devicePixelRatio), xt.bubbleBorder = Math.round(2 * window.devicePixelRatio), xt.bubbleHitbox = Math.round(4 * window.devicePixelRatio), xt.sliceFilters = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1e3].map((e => ({
  ...
  from: e - 99,
  to: e
}))), xt.baseCurrencies = [{id: "usd", symbol: "$", code: "USD"}, {id: "eur", symbol: "€", code: "EUR"}, {
  id: "rub",
  symbol: "₽",
  code: "RUB"
}, {id: "brl", symbol: "R$", code: "BRL"}, {id: "gbp", symbol: "£", code: "GBP"}, {
  id: "inr",
  symbol: "₹",
  code: "INR"
}, {id: "aud", symbol: "$", code: "AUD"}, {id: "cad", symbol: "$", code: "CAD"}, {
  id: "pln",
  symbol: "Zł",
  code: "PLN"
}, {id: "try", symbol: "₺", code: "TRY"}, {id: "btc", symbol: "₿", code: "BTC"}, {
  id: "eth",
  symbol: "Ξ",
  code: "ETH"
}], xt.translations = [Qe, ft, pt, tt, nt, ct, dt, mt, Ke, ot, _t, We, yt, lt, Ge, Ct, Ye], xt.periods = ["min1", "min5", "min15", "hour", "day", "week", "month", "year"], xt.exchanges = [{
  id: "binance",
  name: "Binance",
  ...
  iconComponent: e => {
    return t = je(), r = t.firstChild.nextSibling.nextSibling.firstChild, n = r.nextSibling, ie(t, e, !0, !0), r.style.setProperty("stop-color", "#264CA2"), r.style.setProperty("stop-opacity", "0"), n.style.setProperty("stop-color", "#234588"), t;
    var t, r, n
  }
}, {
  id: "bybit",
...
class At {
  static generateSave() {
    const e = Jt.map((e => ({id: e.id, name: e.name, items: Lt(e.record)})));
    return {
      baseCurrency: Et().id,
      translation: Vt().id,
      configurations2: Ut,
      ...
      if (e) {
        ...
        if (t) {
          if (t.configurations2) {
            let e = !0;
            for (const r of t.configurations2) if (!r.name.startsWith("Chart #")) {
              e = !1;
              break
            }
...
var Ft;
const Ht = Mt.baseCurrencies.find((e => e.id === (null == Tt ? void 0 : Tt.baseCurrency))) || Mt.baseCurrencies[0], [Et, Dt] = v(Ht), [Nt, Ot] = v((null == Tt ? void 0 : Tt.currencyFilter) || Mt.sliceFilters[0]), [Vt, Rt] = v(function (e) {
  const t = Mt.translations.find((t => t.id === (null == e ? void 0 : e.translation)));
  if (t) return t;
  if (navigator.language) {
    const e = navigator.language.toLowerCase();
    for (const t of Mt.translations) if (e.startsWith(t.id.toLowerCase())) return t
  }
  return Qe
}(Tt)), [jt, It] = v((null == Tt ? void 0 : Tt.colors) || "red-green"), [Ut, Wt] = Ae($t), [Xt, Gt] = v(function (e, t) {
...
}(Tt, $t)), [qt, Yt] = Ae(function (e) {
  return (null == e ? void 0 : e.favoritesCMC) ? zt(e.favoritesCMC) : {}
}(Tt)), [Zt, Kt] = Ae(function (e) {
  return (null == e ? void 0 : e.listBlock) ? zt(e.listBlock) : {}
}(Tt)), [Jt, Qt] = Ae(function (e) {
  return (null == e ? void 0 : e.listsWatch) ? e.listsWatch.map((e => ({
    id: e.id,
    name: e.name,
    record: zt(e.items)
  }))) : [Pt()]
}(Tt)), [er, tr] = v((null == Tt ? void 0 : Tt.hideStables) || !1), [rr, nr] = Ae([]), [ir, or] = v("bubbles"), [ar, lr] = v(null), [sr, cr] = v("loading"), [ur, dr] = v(null), [hr, pr] = v(Ht), [gr, fr] = v("");
...
async function mr(e, t) {
  return vr(e, {method: "GET", signal: null == t ? void 0 : t.signal}).then((e => e.json()))
}

async function br(e, t) {
  return vr(e, {method: "POST", body: t})
}
...
function wr() {
  ...
  yr = e;
  const t = hr();
  mr(`data/bubbles1000.${t.id}.json`, e).then((e => {
    for (const t of e) t.image = "/backend/" + t.image, t.nameUpper = t.name.toUpperCase();
    Dt(t), nr($e(e)), cr("loaded")
  })).catch((() => {
    (null == e ? void 0 : e.signal.aborted) || (cr("loading-failed"), pr((() => Et())))
  }))
}
...
const kr = "abcdefghjiklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", Cr = class {
  static create(e) {
    const t = navigator.userAgent.toLowerCase(), r = -1 !== t.indexOf("android"),
  ...
  static postAccess(e) {
    ...
    t.append("session", this.id), t.append("isMobile", this.isMobile ? "1" : "0"), t.append("translation", Vt().id), t.append("basecurrency", Et().id), t.append("env", `${e}-2024-3-5-20-13`), document.referrer && t.append("referer", document.referrer), br("access.php", t)
  }
...
function Br(e) {
  return (t = Lr()).$$click = () => xr.logAction("CLICK_LINK", e.name), ae(t, (() => e.children)), m((r => {
    var n = e.href, i = e.title, o = e.class;
...
function Ar() {
  return V(Br, {
    class: "banner", get href() {
      return Mt.playStore
    }, title: "Download App", name: "GooglePlay_Banner", get children() {
      return [Sr(), V(zr, {})]
    }
  })
}
...
function Fr() {
  return V(Br, {
    class: "banner", get href() {
      return Mt.appStore
    }, title: "Download App", name: "AppStore_Banner", get children() {
      return [$r(), V(Tr, {})]
    }
  })
}
...
function Nr(e) {
  return (t = Dr()).$$click = t => e.onClick(t), ae(t, (() => e.children)), m((r => {
    var n = Er("icon-button", e.active && "active", e.hidden && "hidden", e.class), i = e.title,
      o = e.hidden ? -1 : void 0;
...
var Rr = Q('<svg viewBox="0 0 24 24"><path d="M19.14,12.94c0.04-0.3,0.06-0.61,0.06-0.94c0-0.32-0.02-0.64-0.07-0.94l2.03-1.58c0.18-0.14,0.23-0.41,0.12-0.61 l-1.92-3.32c-0.12-0.22-0.37-0.29-0.59-0.22l-2.39,0.96c-0.5-0.38-1.03-0.7-1.62-0.94L14.4,2.81c-0.04-0.24-0.24-0.41-0.48-0.41 h-3.84c-0.24,0-0.43,0.17-0.47,0.41L9.25,5.35C8.66,5.59,8.12,5.92,7.63,6.29L5.24,5.33c-0.22-0.08-0.47,0-0.59,0.22L2.74,8.87 C2.62,9.08,2.66,9.34,2.86,9.48l2.03,1.58C4.84,11.36,4.8,11.69,4.8,12s0.02,0.64,0.07,0.94l-2.03,1.58 c-0.18,0.14-0.23,0.41-0.12,0.61l1.92,3.32c0.12,0.22,0.37,0.29,0.59,0.22l2.39-0.96c0.5,0.38,1.03,0.7,1.62,0.94l0.36,2.54 c0.05,0.24,0.24,0.41,0.48,0.41h3.84c0.24,0,0.44-0.17,0.47-0.41l0.36-2.54c0.59-0.24,1.13-0.56,1.62-0.94l2.39,0.96 c0.22,0.08,0.47,0,0.59-0.22l1.92-3.32c0.12-0.22,0.07-0.47-0.12-0.61L19.14,12.94z M12,15.6c-1.98,0-3.6-1.62-3.6-3.6 s1.62-3.6,3.6-3.6s3.6,1.62,3.6,3.6S13.98,15.6,12,15.6z">');
const jr = e => {
  return ie(t = Rr(), e, !0, !0), t;
  var t
};
var Ir = Q('<svg width=24 height=12 viewBox="0 6 24 12"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z">');
const Ur = e => {
  return ie(t = Ir(), e, !0, !0), t;
  var t
};
var Wr = Q('<svg viewBox="0 0 24 24"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z">');
const Xr = e => {
  return ie(t = Wr(), e, !0, !0), t;
  var t
};
var Gr = Q('<svg viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z">');
const qr = e => {
  return ie(t = Gr(), e, !0, !0), t;
  var t
};
var Yr = Q('<svg viewBox="0 0 24 24"><path d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z">');
const Zr = e => {
...
function tn(e) {
  ...
  const i = y((() => {
    const r = document.documentElement.clientWidth, n = Qr(), i = e.anchor.getBoundingClientRect(),
      o = i.x + i.width / 2, a = i.y + i.height / 2 > n / 2,
...
function rn(e) {
  ...
  return V(Nr, {
    class: "select-navigator", get hidden() {
      return !t()
    }, get title() {
      var e;
      return null == (e = t()) ? void 0 : e.label
    }, onClick: () => e.onChange(t().value), get children() {
      return e.children
    }
  })
}
...
function on(e) {
  return (t = nn()).$$click = t => e.onClick(t), ae(t, (() => e.children)), m((r => {
    var n = Er("solid-button", e.active && "active", e.class), i = e.title;
...
function ln(e) {
  return ae((t = an()).firstChild, (() => e.label)), ae(t, V(j, {
    get each() {
      return e.options
    }, children: t => V(on, {
      get active() {
        return t.value === e.value
      }, class: "select-option", onClick: () => e.onChange(t.value), get children() {
        return [V(I, {
          keyed: !0, get when() {
...
var sn = Q("<div class=select-popup-content>"), cn = Q("<ul class=menu>"), un = Q("<li><span class=grow>");
...
function dn(e) {
  ...
  const i = y((() => JSON.stringify(e.value))), o = y((() => {
    const t = [];
    for (const r of e.children) for (const e of r.options) t.push(e);
    return t
  })), a = y((() => {
    let t = 0;
    for (const r of e.children) for (const e of r.options) {
      if (JSON.stringify(e.value) === i()) return {index: t, option: e};
      t++
    }
  ...
  return [V(I, {
    ...
    }, onClick: e => r(e.currentTarget), get children() {
      return [V(I, {
        keyed: !0, get when() {
          return a().option.iconComponent
        }, children: e => V(e, {})
      }), y((() => a().option.label)), V(Ur, {class: "select-button-arrow color-secondary"})]
    }
  }), V(I, {
    get when() {
      return e.withNavigator
    ...
    keyed: !0, get when() {
      ...
      }, anchor: t, onClose: () => r(null), get children() {
        return V(I, {
          get when() {
            return l()
          }, get fallback() {
            return ae(t = cn(), V(j, {
              get each() {
                ...
                return t = un(), r = t.firstChild, t.$$click = () => n(e.value), ae(t, V(I, {
                  get when() {
                ...
                }), r), ae(r, (() => e.label)), m((() => re(t, Er("menu-item", JSON.stringify(e.value) === i() && "selected")))), t;
                var t, r
              }
            })), t;
            var t
            ...
            return ae(t, V(j, {
              get each() {
                ...
                get label() {
                  ...
                  return i()
                }, onChange: e => n(JSON.parse(e)), get options() {
...
ee(["click"]);
var hn = Q('<svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-4.42 3.58-8 8-8 1.85 0 3.55.63 4.9 1.69L5.69 16.9C4.63 15.55 4 13.85 4 12zm8 8c-1.85 0-3.55-.63-4.9-1.69L18.31 7.1C19.37 8.45 20 10.15 20 12c0 4.42-3.58 8-8 8z">');
const pn = e => {
  return ie(t = hn(), e, !0, !0), t;
  var t
};
var gn = Q('<svg viewBox="0 0 24 24"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z">');
const fn = e => {
  return ie(t = gn(), e, !0, !0), t;
  var t
};
var vn = Q('<svg viewBox="0 0 24 24"><path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z">');
const mn = e => {
...
function Cn(e) {
  return V(I, {
    when: !_n, get children() {
      return V(dn, {
        type: "filter", get value() {
          return Nt()
        }, onChange: Ot, get withNavigator() {
          return e.withNavigator
        }, get children() {
          return [{
            label: Vt().pages,
            options: Mt.sliceFilters.map((e => ({label: `${e.from} - ${e.to}`, value: e})))
          }, {
            label: Vt().lists,
            options: wn().map((e => ({label: e.name, value: e.filter, iconComponent: e.iconComponent})))
          }, {
            label: Vt().exchanges,
...
var xn = Q('<svg viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z">');
const Mn = e => {
  return ie(t = xn(), e, !0, !0), t;
  var t
};
var zn = Q('<svg viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z">');
const Ln = e => {
  return ie(t = zn(), e, !0, !0), t;
  var t
};
var Bn = Q("<div class=window-content>"), Sn = Q('<section><header class="flex-row gap-m">');

function An(e) {
  const [t, r] = v(!0);
  return b((() => {
    xr.registerCloseListener(e.onClose), k((() => xr.unregisterCloseListener(e.onClose)))
  })), n = Sn(), ae(i = n.firstChild, V(Nr, {
    get class() {
      return Er("expand-button", t() && "expanded")
    }, onClick: () => r(!t()), get title() {
      return Vt().window_toggleExpand
    }, get children() {
      return V(Ln, {})
    }
  }), null), ae(i, (() => e.header), null), ae(i, V(Nr, {
    get onClick() {
      return e.onClose
    }, get title() {
  ...
  }), null), m((() => re(n, Er("window", e.class)))), n;
  var n, i
}

var Pn = Q('<svg viewBox="0 0 24 24"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z">');
const Tn = e => {
...
function Fn(e) {
  const [t, r] = v(null);
  return [(n = $n(), n.$$click = e => r(e.currentTarget), ae(n, (() => e.content)), m((r => {
    var i = Er(e.solid ? "solid-button" : "icon-button", t() && "active", e.class), o = e.title;
    return i !== r.e && re(n, r.e = i), o !== r.t && te(n, "title", r.t = o), r
  }), {e: void 0, t: void 0}), n), V(I, {
    keyed: !0, get when() {
      return t()
    }, children: t => V(tn, {
      get width() {
...
function En(e) {
  return V(Fn, {
    get title() {
      ...
      var t = Hn(), r = t.firstChild, n = r.firstChild, i = r.nextSibling;
      return r.$$click = () => e.onDelete(), ae(r, V(Tn, {}), n), ae(n, (() => Vt().confirm)), ae(i, V(Mn, {}), null), ae(i, (() => Vt().cancel), null), t
    }
  })
}
...
function Un(e) {
  ...
  return (() => {
    ...
    return "function" == typeof n ? oe(n, i) : n = i, ae(r, V(U, {
      get children() {
        return [V(W, {
          get when() {
            ...
            return V(Nr, {
              title: "Clear", get hidden() {
                return s()
              }, class: "input-action", get active() {
                return t()
      ...
      var n = Er("input", e.class), o = e.type, a = e.placeholder, l = e.readonly;
      return n !== t.e && re(r, t.e = n), o !== t.t && te(i, "type", t.t = o), a !== t.a && te(i, "placeholder", t.a = a), l !== t.o && (i.readOnly = t.o = l), t
    }), {e: void 0, t: void 0, a: void 0, o: void 0}), m((() => i.value = e.value)), r
  })()
}
...
function Xn() {
  return V(dn, {
    type: "basecurrency", get value() {
      return hr()
    }, onChange: pr, get children() {
      return [{
        label: "Fiat",
        options: Mt.baseCurrencies.filter((e => !Wn[e.code])).map((e => ({value: e, label: `${e.symbol} ${e.code}`})))
      }, {
        label: "Crypto",
        options: Mt.baseCurrencies.filter((e => Wn[e.code])).map((e => ({value: e, label: `${e.symbol} ${e.code}`})))
      }]
...
function Gn() {
  return V(dn, {
    type: "colors", get value() {
      return jt()
    }, onChange: It, get children() {
      return [{
        label: "",
        options: [{value: "red-green", label: Vt().red_green}, {value: "yellow-blue", label: Vt().yellow_blue}]
      }]
    }
  })
}
...
function qn() {
  return V(dn, {
    type: "translation", get value() {
      return Vt().id
    }, onChange: function (e) {
      const t = Mt.translations.find((t => t.id === e));
      t && Rt(t)
    }, get children() {
      return [{label: "", options: Mt.translations.map((e => ({value: e.id, label: e.name, iconComponent: e.flag})))}]
    }
  })
}

var Yn = Q('<svg viewBox="0 0 24 24"><path d="M23,12L19,8V11H10V13H19V16M1,18V6C1,4.89 1.9,4 3,4H15A2,2 0 0,1 17,6V9H15V6H3V18H15V15H17V18A2,2 0 0,1 15,20H3A2,2 0 0,1 1,18Z">');
const Zn = e => {
  return ie(t = Yn(), e, !0, !0), t;
  var t
};
var Kn = Q('<svg viewBox="0 0 24 24"><path d="M14,12L10,8V11H2V13H10V16M20,18V6C20,4.89 19.1,4 18,4H6A2,2 0 0,0 4,6V9H6V6H18V18H6V15H4V18A2,2 0 0,0 6,20H18A2,2 0 0,0 20,18Z">');
const Jn = e => {
  return ie(t = Kn(), e, !0, !0), t;
  var t
};
var Qn = Q('<svg viewBox="0 0 24 24"><path d=M12.89,3L14.85,3.4L11.11,21L9.15,20.6L12.89,3M19.59,12L16,8.41V5.58L22.42,12L16,18.41V15.58L19.59,12M1.58,12L8,5.58V8.41L4.41,12L8,15.58V18.41L1.58,12Z>');
const ei = e => {
...
function ri(e) {
  return (t = ti()).$$click = e => e.stopImmediatePropagation(), ae(t, (() => e.children)), t;
  var t
}

ee(["click"]);
var ni = Q("<p>This will import the exported data and <strong>DELETE</strong> your current data."),
  ii = Q("<button class=solid-button>"), oi = Q("<button class=solid-button>Import");
  ...
  return V(ri, {
    get children() {
      return [ni(), V(Un, {
        get value() {
          return e()
        }, onInput: t, placeholder: "Paste exported data here"
      }), V(I, {
        keyed: !0, get when() {
          return r()
        }, get fallback() {
          return ae(t = ii(), (() => "" === e() ? "Data is empty" : "Data is invalid")), t;
          var t
        }, children: e => {
          return t = oi(), r = t.firstChild, t.$$click = () => {
...
var li = Q("<p class=no-margin-bottom>Full experience"),
  si = Q("<p>You can also generate the HTML widget for one of your lists. But currently all your lists are empty."),
  ci = Q('<p class="flex-row gap-m no-margin-bottom">');

function ui() {
  const e = "https://cryptobubbles.net", t = 'width="1300px" height="700px" style="border: none" loading="lazy"';
  return V(ri, {
    get children() {
      return [li(), V(Un, {
        readonly: !0,
        ...
        get each() {
          ...
          return [(i = ci(), ae(i, V(r.iconComponent, {}), null), ae(i, (() => r.name), null), i), V(Un, {
            readonly: !0,
            action: "copy",
...
function di() {
  return V(dn, {
    type: "hidestables", get value() {
      return er()
    }, onChange: tr, get children() {
      return [{label: "", options: [{value: !1, label: Vt().show}, {value: !0, label: Vt().hide}]}]
    }
  })
}

var hi = Q('<li class=flex-row><span class="grow color-secondary">Stablecoins'),
  pi = Q('<li class=settings-watchlists><div class="settings-watchlists-header flex-row color-secondary"><span></span></div><ul class=settings-watchlists-list>'),
  gi = Q("<p>This contains your settings and lists. Use it as a backup or to import your data to another device."),
  fi = Q("<li class=settings-buttons>"),
  vi = Q('<ul class=settings-page><li class=flex-row><span class="grow color-secondary"></span></li><li class=flex-row><span class="grow color-secondary"></span></li><li class=flex-row><span class="grow color-secondary">'),
  mi = Q('<li class="flex-row gap-m">');

function bi() {
  return e = vi(), t = e.firstChild, r = t.firstChild, n = t.nextSibling, i = n.firstChild, o = n.nextSibling, a = o.firstChild, ae(r, (() => Vt().currency)), ae(t, V(Xn, {}), null), ae(i, (() => Vt().language)), ae(n, V(qn, {}), null), ae(a, (() => Vt().colors)), ae(o, V(Gn, {}), null), ae(e, V(I, {
    when: !_n, get children() {
      return [(o = hi(), o.firstChild, ae(o, V(di, {}), null), o), (t = pi(), r = t.firstChild, n = r.firstChild, i = r.nextSibling, ae(n, (() => Vt().watchlists)), ae(r, V(Nr, {
        class: "button-add",
        get title() {
        ...
        each: Jt, children: (e, t) => {
          return ae(r = mi(), V(Un, {
            get value() {
              return e.name
            }, action: "clear", class: "grow", iconComponent: Vn, get placeholder() {
              return bn(t())
            }, onInput: e => Qt(t(), "name", e)
          }), null), ae(r, V(En, {
            onDelete: () => function (e) {
              Qt((t => t.filter((t => t.id !== e.id)))), Ot((t => "list" === t.type && "watch" === t.list[0] && t.list[1] === e.id ? Mt.sliceFilters[0] : t))
            }(e)
          }), null), r;
          var r
        }
      })), t), (e = fi(), ae(e, V(Fn, {
        solid: !0, popupWidth: 400, get content() {
          return [V(Zn, {}), "Export settings + lists"]
        }, get children() {
          return V(ri, {
            get children() {
              return [gi(), V(Un, {
                readonly: !0, action: "copy", get value() {
...
function wi(e) {
  return V(An, {
    class: "settings-window", get onClose() {
      return e.onClose
    }, get header() {
  ...
  return V(I, {
    get when() {
      ...
      return V(fe, {
        get children() {
          var r = _i();
          return ae(r, V(e.component, {
            get value() {
              return o()
            }, get onClose() {
              return e.onClose
            }
          })), m((() => re(r, Er("window-host", t())))), r
        }
      })
    }
  })
...
var Ci = Q('<svg viewBox="0 0 24 24"><path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z">');
const xi = e => {
...
function zi(e) {
  return t = Mi(), ae((r = t.firstChild).nextSibling, (() => e.currency.name)), m((n => {
    var i = Er("flex-row gap-m", e.class), o = e.currency.image, a = e.currency.name, l = `Logo of ${e.currency.name}`;
      ...
      const t = function (e) {
        switch (e.list[0]) {
          case"block":
            return Zt;
          case"watch": {
            const t = e.list[1], r = Jt.find((e => e.id === t));
...
const {
  ...
  filteredCurrencies: y((() => {
    ...
    const e = Nt(), t = Li(e);
    let r = t;
    return "list" !== e.type && (r = er() ? e => !e.stable && !Si(e) && t(e) : e => !Si(e) && t(e)), rr.filter(r)
    ...
    const e = gr().trim().toUpperCase(), t = [];
    for (const r of rr) if (kn(r) && (r.nameUpper.includes(e) || r.symbol.includes(e)) && (t.push(r), 10 === t.length)) break;
    return t
  }
})));
var Fi = Q('<ul class="menu search-results">'), Hi = Q("<p class=center>"),
  Ei = Q('<li><span class="color-secondary right"></span><span class=text-secondary>');
    ...
    get when() {
      ...
      return t.$$mousedown = e => {
        ...
        get each() {
          ...
          return n = Ei(), i = n.firstChild, o = i.nextSibling, n.$$click = () => e.onSelect(t), i.style.setProperty("width", "2.5em"), ae(i, (() => t.rank)), ae(n, V(zi, {
            currency: t,
            class: "grow"
          }), o), ae(o, (() => t.symbol)), m((() => re(n, Er("menu-item", r() === e.focusIndex && "focused")))), n;
          var n, i, o
        }
      })), t
    }
...
function ji(e) {
  ...
  return [V(Un, {
    get value() {
      ...
      return !Oi()
    }, iconComponent: xi, get placeholder() {
    ...
    keyed: !0, get when() {
      ...
      width: "inherit-from-anchor", anchor: e, get children() {
        return V(Di, {
          get focusIndex() {
            return n()
          }, onSelect: o
...
var Ii = Q('<svg viewBox="0 -960 960 960"><path d=M120-200v-80h720v80H120Zm0-160v-80h720v80H120Zm0-160v-80h720v80H120Zm0-160v-80h720v80H120Z>');
const Ui = e => {
...
function Wi() {
  const e = () => window.innerHeight / 2, t = () => window.scrollY >= e() / 2, [r, n] = v(t());

  function i() {
    n(t())
  }

  return window.addEventListener("scroll", i), k((() => {
...
var Xi = Q('<div class="flex-row gap-m header-padded">'), Gi = Q("<header><img class=logo><h1></h1><div class=grow>");

function qi() {
  const [e, t] = v(!1), [r, n] = v(!1);
  return i = Gi(), o = i.firstChild, (a = o.nextSibling).nextSibling, ae(a, (() => Mt.app)), ae(i, V(I, {
    get when() {
      return Oi()
    }, get fallback() {
      return V(I, {
        get when() {
          ...
          return V(ji, {onBlur: () => n(!1)})
        }
      })
    }, get children() {
      return [V(ji, {}), (r = Xi(), ae(r, V(Cn, {withNavigator: !0})), r), V(Xn, {}), V(Wi, {}), V(Nr, {
        get active() {
          return e()
        }, onClick: () => t((e => !e)), get title() {
          return Vt().settings
        }, get children() {
          return V(jr, {})
        }
        ...
        get value() {
          return e()
        }, component: wi, onClose: () => t(!1)
      })];
      var r
    }
  }), null), ae(i, V(Vr, {}), null), m((e => {
    var t = Er("header flex-row gap-m", r() && "mobile-search-open"), n = Mt.logo, a = Mt.app, l = `Logo of ${Mt.app}`;
...
var Yi = Q('<svg viewBox="0 0 24 24"><path d="M7.8,2H16.2C19.4,2 22,4.6 22,7.8V16.2A5.8,5.8 0 0,1 16.2,22H7.8C4.6,22 2,19.4 2,16.2V7.8A5.8,5.8 0 0,1 7.8,2M7.6,4A3.6,3.6 0 0,0 4,7.6V16.4C4,18.39 5.61,20 7.6,20H16.4A3.6,3.6 0 0,0 20,16.4V7.6C20,5.61 18.39,4 16.4,4H7.6M17.25,5.5A1.25,1.25 0 0,1 18.5,6.75A1.25,1.25 0 0,1 17.25,8A1.25,1.25 0 0,1 16,6.75A1.25,1.25 0 0,1 17.25,5.5M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9Z">');
const Zi = e => {
  return ie(t = Yi(), e, !0, !0), t;
  var t
};
var Ki = Q('<svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z">');
const Ji = e => {
  return ie(t = Ki(), e, !0, !0), t;
  var t
};
var Qi = Q('<svg viewBox="0 0 300 271"width=24 height=24><path d="m236 0h46l-101 115 118 156h-92.6l-72.5-94.8-83 94.8h-46l107-123-113-148h94.9l65.5 86.6zm-16.1 244h25.5l-165-218h-27.4z">');
const eo = e => {
  return ie(t = Qi(), e, !0, !0), t;
  var t
};
var to = Q("<div class=support-crypto><div class=support-crypto-options>"), ro = Q("<p class=color-secondary>Version ");
const no = [{name: "BTC", address: "bc1q8pep7zf7txjcjrslse7crqlgr0f36fwuxnzad0"}, {
  name: "ETH",
...
}, {name: "XLM", address: "GALMTBOTY4FQ4GBZW5X4XH3673SWEAYB3CPMEVGTX67NNXNV6DV77BWN"}, {
  name: "XMR",
...
function io() {
  const [e, t] = v(null);
  return ae((r = to()).firstChild, V(j, {
    each: no, children: r => V(on, {
      get active() {
        return e() === r
      }, onClick: () => t((e => e === r ? null : r)), get children() {
        return r.name
      }
    })
  })), ae(r, V(I, {
...
var oo = Q('<svg viewBox="0 0 512 512"><path d="m484.689 98.231-69.417 327.37c-5.237 23.105-18.895 28.854-38.304 17.972L271.2 365.631l-51.034 49.086c-5.647 5.647-10.372 10.372-21.256 10.372l7.598-107.722L402.539 140.23c8.523-7.598-1.848-11.809-13.247-4.21L146.95 288.614 42.619 255.96c-22.694-7.086-23.104-22.695 4.723-33.579L455.423 65.166c18.893-7.085 35.427 4.209 29.266 33.065z">');
const ao = e => {
      ...
      return V(j, {
        get each() {
          ...
          keyed: !0, get when() {
            ...
            class: "menu-item", href: t, get title() {
              return `Register on ${e.name}`
            }, get name() {
              return `${e.name}_Register`
            }, get children() {
              return [V(e.iconComponent, {}), (t = lo(), ae(t, (() => e.name)), t), V(qr, {})];
              var t
            }
          })
        })
...
var co = Q('<footer><section><p class="flex-row gap-m"><img width=32 height=32><span></span></p><h2></h2><p>Crypto Bubbles is available as a website at cryptobubbles.net and as an app for your phone.</p><p>No financial advice. Do your own research!</p><p>Ulrich Stark, 92637 Weiden, Germany<br></p><nav class="flex-row gap-m"></nav></section><section class="support-my-work flex-column gap-m"><h2>');

function uo() {
  return (() => {
    var e = co(), t = e.firstChild, r = t.firstChild, n = r.firstChild, i = n.nextSibling, o = r.nextSibling,
      a = o.nextSibling.nextSibling.nextSibling;
    a.firstChild.nextSibling;
    var l = a.nextSibling, s = t.nextSibling, c = s.firstChild;
    return ae(i, (() => Mt.app)), ae(o, (() => Vt().description)), ae(a, (() => Mt.email), null), ae(l, V(I, {
      get when() {
        return xr.isWeb
      }, get children() {
        return [V(Br, {
          class: "icon-button", get href() {
            return Mt.playStore
          }, title: "Crypto Bubbles on Play Store", name: "GooglePlay", get children() {
            return V(zr, {})
          }
        }), V(Br, {
          class: "icon-button", get href() {
            return Mt.appStore
          }, title: "Crypto Bubbles on App Store", name: "AppStore", get children() {
            return V(Tr, {})
          }
        })]
      }
      ...
      class: "icon-button", get href() {
        return `mailto:${Mt.email}`
      }, get title() {
        return `Send E-Mail to ${Mt.email}`
      }, name: "Mail", get children() {
        return V(Ji, {})
      }
    }), null), ae(l, V(Br, {
      class: "icon-button", get href() {
        return `https://www.instagram.com/${Mt.instagram}`
      }, get title() {
        return `@${Mt.instagram} on Instagram`
      }, name: "Instagram", get children() {
        return V(Zi, {})
      }
    }), null), ae(l, V(Br, {
      class: "icon-button", get href() {
        return `https://t.me/${Mt.telegram}`
      }, get title() {
        return `@${Mt.telegram} on Telegram`
      }, name: "Telegram", get children() {
        return V(ao, {})
      }
    }), null), ae(l, V(Br, {
      class: "icon-button", get href() {
        return `https://twitter.com/${Mt.twitter}`
      }, get title() {
        return `@${Mt.twitter} on X`
      }, name: "Twitter", get children() {
        return V(eo, {})
      }
    }), null), ae(c, (() => Vt().support_my_work)), ae(s, V(I, {
      get when() {
        return "ios" === xr.env
      }, get children() {
        return V(Br, {
          class: "solid-button", get href() {
            return Mt.appStore
          }, name: "AppStore_Rate", get children() {
            return ["Rate App on App Store ", V(Tr, {})]
          }
        })
      }
    }), null), ae(s, V(I, {
      get when() {
        ...
        return V(Br, {
          class: "solid-button", get href() {
            return Mt.playStore
          }, name: "GooglePlay_Rate", get children() {
            return ["Rate App on Play Store ", V(zr, {})]
          }
        })
      }
    }), null), ae(s, V(Br, {
      class: "solid-button", get href() {
        return `https://twitter.com/intent/follow?screen_name=${Mt.twitter}`
      }, name: "Twitter_Follow", get children() {
        return ["Follow Crypto Bubbles on ", V(eo, {})]
      }
    }), null), ae(s, V(so, {}), null), ae(s, V(io, {}), null), m((e => {
      var t = Mt.logo, r = Mt.app, i = `Logo of ${Mt.app}`;
      return t !== e.e && te(n, "src", e.e = t), r !== e.t && te(n, "alt", e.t = r), i !== e.a && te(n, "title", e.a = i), e
    }), {e: void 0, t: void 0, a: void 0}), e
  })()
}
...
function go(e, t) {
  ...
  const n = {style: "percent", signDisplay: t ? "never" : "exceptZero", maximumFractionDigits: r >= 1 ? 0 : 1};
...
var vo = Q('<svg viewBox="0 0 24 24"><path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z">');
const mo = e => {
  return ie(t = vo(), e, !0, !0), t;
  var t
};
var bo = Q("<ul class=menu>"), yo = Q("<li><span class=grow>");

function wo(e) {
  return V(I, {
    when: !_n, get children() {
      return V(Fn, {
        class: "button-lists", get title() {
          ...
          return [V(Nn, {}), V(j, {
            get each() {
              return (() => {
                ...
                for (const r of Jt) if (Bi(e.currency, r.record)) {
                  t.push(mn);
                  break
                }
                return t
          ...
          return ae(t, V(j, {
            get each() {
              ...
              return r = yo(), n = r.firstChild, r.$$click = r => {
                t.toggleCurrency(e.currency), r.stopImmediatePropagation()
              }, ae(r, V(t.iconComponent, {}), n), ae(n, (() => t.name)), ae(r, V(I, {
                get when() {
              ...
              }), null), m((() => re(r, Er("menu-item", Bi(e.currency, t.record) && "selected")))), r;
              var r, n
            }
          })), t
        }
...
function Co(e) {
  return V(I, {
    keyed: !0, get when() {
      ...
      href: `https://coinmarketcap.com/currencies/${t}`, get title() {
        return Vt().info_tooltip.replace("(currency)", e.currency.name).replace("(service)", "CoinMarketCap")
      }, name: "CMC", class: "icon-button", get children() {
        return V(ko, {})
      }
    })
  })
...
function zo(e) {
  return V(I, {
    keyed: !0, get when() {
      ...
      href: `https://www.coingecko.com/coins/${t}`, get title() {
        return Vt().info_tooltip.replace("(currency)", e.currency.name).replace("(service)", "CoinGecko")
      }, name: "CoinGecko", class: "icon-button", get children() {
        return V(Mo, {})
      }
    })
  })
...
var Lo = Q("<div>"), Bo = Q("<span class=grow>");

function So(e) {
  function t(t) {
    return Vt().trade_tooltip.replace("(currency)", e.currency.name).replace("(exchange)", t)
  }
  ...
  const r = y((() => {
    ...
    for (const n of Mt.exchanges) {
      ...
      t.push({exchange: n, symbol: i}), i && r++
    }
    return {items: t, count: r}
  }));
  return V(I, {
    get when() {
      return r().count > 0
            ...
            get each() {
              ...
              keyed: !0, get when() {
                ...
                class: "menu-item", get href() {
                  ...
                  return [V(e.exchange.iconComponent, {}), (t = Bo(), ae(t, (() => e.exchange.name)), t), V(qr, {})];
                  var t
                }
              })
            })
...
function Eo(e) {
  const t = e.children, [r, n] = v(t), [i, o] = v(t), [a, l] = v(""), s = new Fo(t, 500);
  let c = null;
  const u = () => {
    s.isDone() ? (o(r()), l(""), c = null) : (o(s.get()), c = requestAnimationFrame(u))
  };
  b((() => {
    const t = r(), i = e.children;
    if (t !== i) {
      n(i), s.set(i);
      const r = i - t, o = To(e.reverseColor ? -r : r, jt());
...
var Do = Q('<svg width=24 height=12 viewBox="0 6 24 12"><path d="M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z">');
const No = e => {
  return ie(t = Do(), e, !0, !0), t;
  var t
};
var Oo = Q('<span class="currency-rank-change flex-column">'), Vo = Q("<span class=currency-rank>");

function Ro(e) {
  const t = () => e.currency.rankDiffs[e.period], r = () => To(t(), jt());
  return ae(n = Vo(), V(I, {
    get when() {
      return t() < 0
    }, get children() {
      var e = Oo();
      return ae(e, (() => Math.abs(t())), null), ae(e, V(Ur, {}), null), m((() => null != r() ? e.style.setProperty("color", r()) : e.style.removeProperty("color"))), e
    }
  }), null), ae(n, V(I, {
    get when() {
      return t() > 0
      ...
      var e = Oo();
      return ae(e, V(No, {}), null), ae(e, t, null), m((() => null != r() ? e.style.setProperty("color", r()) : e.style.removeProperty("color"))), e
    }
  }), null), ae(n, V(I, {
    get when() {
      return e.animate
      ...
      return V(Eo, {
        format: "integer", reverseColor: !0, get children() {
          return e.currency.rank
        }
      })
    }
...
var jo = Q("<td class=center>"),
  Io = Q('<tr><td class=right></td><td><div class="flex-row gap-m"></div></td><td class=right></td><td class=right></td><td class="right padding-right"></td><td>');

function Uo(e) {
  function t(e) {
    return ae(t = jo(), (() => go(e))), m((() => null != $o(e, jt()) ? t.style.setProperty("background-color", $o(e, jt())) : t.style.removeProperty("background-color"))), t;
    var t
  }

  return r = Io(), n = r.firstChild, i = n.nextSibling, o = i.firstChild, a = i.nextSibling, l = a.nextSibling, s = l.nextSibling, c = s.nextSibling, ae(n, V(Ro, {
    get currency() {
      return e.currency
    }, period: "day"
  })), ae(o, V(wo, {
    ...
    class: "currency-name", onClick: () => ho(e.currency.id), get active() {
  ...
  }), null), ae(a, (() => po(e.currency.price, Et()))), ae(l, (() => po(e.currency.marketcap, Et()))), ae(s, (() => po(e.currency.volume, Et()))), ae(r, (() => t(e.currency.performance.hour)), c), ae(r, (() => t(e.currency.performance.day)), c), ae(r, (() => t(e.currency.performance.week)), c), ae(r, (() => t(e.currency.performance.month)), c), ae(r, (() => t(e.currency.performance.year)), c), ae(c, V(Po, {
    get currency() {
      return e.currency
    }, tabular: !0
  })), r;
...
var Wo = Q('<svg viewBox="0 0 24 24"><path d="M20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8 8-8z">');
const Xo = e => {
  return ie(t = Wo(), e, !0, !0), t;
  var t
};
var Go = Q("<div class=scroll-container><table><thead><tr><th></th></tr></thead><tbody>"), qo = Q("<th><div><span>");
const Yo = [{label: () => "#", sortComparator: (e, t) => t.rank - e.rank}, {
...
}, {label: () => Vt().marketcap, sortComparator: (e, t) => t.marketcap - e.marketcap}, {
  label: () => Vt().volume,
...
}, {label: () => Vt().period_year, sortComparator: (e, t) => (t.performance.year || 0) - (e.performance.year || 0)}];

function Zo(e) {
  const [r, n] = v("");
  let i, o;
  const l = function (e, r = t, n) {
    const i = new Map, o = B((t => {
      const n = e();
      for (const [e, o] of i.entries()) if (r(e, n) !== r(e, t)) for (const t of o.values()) t.state = a, t.pure ? h.push(t) : p.push(t);
      return n
    }), void 0, !0, a);
    return L(o), e => {
      const t = d;
      if (t) {
        let r;
        (r = i.get(e)) ? r.add(t) : i.set(e, r = new Set([t])), k((() => {
  ...
  function s() {
    ...
    if (o && i) {
      const e = -1 * o.getBoundingClientRect().top, t = Math.max(0, Math.round(e + i));
      n(`transform:translateY(${t}px)`)
    }
  }

  return window.addEventListener("scroll", s), k((() => window.removeEventListener("scroll", s))), c = Go(), u = c.firstChild, g = u.firstChild, f = g.firstChild, b = f.firstChild, y = g.nextSibling, "function" == typeof o ? oe(o, u) : o = u, ae(f, V(j, {
    each: Yo,
    children: e => {
      return t = qo(), r = t.firstChild, n = r.firstChild, t.$$click = () => function (e) {
        dr((t => t && t.column === e ? "asc" === t.direction ? null : {...t, direction: "asc"} : {
          column: e,
          direction: "desc"
        }))
      }(e), ae(r, V(Xo, {}), n), ae(n, (() => e.label())), m((n => {
        var i, o = Er("sortable", l(e) && `sorted-${null == (i = ur()) ? void 0 : i.direction}`),
          a = Er("flex-row", e.class);
        return o !== n.e && re(t, n.e = o), a !== n.t && re(r, n.t = a), n
      }), {e: void 0, t: void 0}), t;
      var t, r, n
    }
  }), b), ae(b, (() => Vt().links)), ae(y, V(j, {
    get each() {
      return e.rows
    }, children: e => V(Uo, {currency: e})
  })), m((e => ne(g, r(), e))), c;
  var c, u, g, f, b, y
}
...
const ra = {red: 127, green: 127, blue: 127};

function na(e, t, r) {
  if (0 === e || 0 === r) return ra;
  const n = Math.abs(e) / r, i = Math.min(1, Math.max(.2, n)), o = Math.floor(127 * (1 - i)),
    a = Math.floor(155 + 100 * i);
  return e > 0 ? "yellow-blue" === t ? {red: o, green: o + 70, blue: a} : {
    red: o,
    green: a,
    blue: o
  } : "yellow-blue" === t ? {red: a, green: a, blue: o} : {red: a, green: o, blue: o}
}
...
function aa(e, t, r, n) {
  switch (t) {
    ...
    case"rank-diff": {
      ...
      return 0 === t ? "-" : t.toLocaleString(void 0, {signDisplay: "always"})
    }
  }
}
...
const pa = new Date, ga = pa.getDate(),
  fa = 11 === pa.getMonth() && ga >= 19 && ga <= 25 ? [da.get("/images/christmas1.png"), da.get("/images/christmas2.png"), da.get("/images/christmas3.png")] : [];

class va {
  constructor(e) {
    this.lastFingerprint = "", this.radiusTween = new Fo(0, 1e3), this.color = "", this.transitionRadius = null, this.posX = 0, this.posY = 0, this.speedX = 0, this.speedY = 0, this.size = 0, this.radius = 0, this.content = "", this.visible = !1, this.latestPush = 0, this.renderFavoriteBorder = !0, this.currency = e, this.canvas = new ha(Mt.bubblePadding), this.lazyImage = da.get(e.image)
  }
  ...
  rerender(e) {
    const t = this.lazyImage(), r = Math.round(e), n = this.renderFavoriteBorder && fo(this.currency),
    ...
    if (i !== this.lastFingerprint) {
      ...
      const a = r > 30, l = r * (a ? .55 : 1.2), s = l * (t ? t.width / t.height : 1), c = .5 * (e - s),
        u = (e - l) * (a ? .14 : .5);
      if (t) this.canvas.drawImage(t, c, u, s, l); else {
        const e = .5 * l;
      ...
      if (a) {
        ...
        this.canvas.fillText(this.content, r, 1.65 * r, n), fa.forEach(((t, r) => {
  ...
  render(e) {
    const t = this.radius + Mt.bubblePadding, r = this.posX - t, n = this.posY - t;
  ...
  constructor(e) {
    this.frameHandle = null, this.lastTime = null, this.elementWidth = 0, this.elementHeight = 0, this.nextContainerFill = 0, this.width = 0, this.height = 0, this.eventResize = new _r, this.eventFrame = new _r, this.frame = e => {
      ...
      const e = this.container.clientWidth - 1, t = this.container.clientHeight - 1,
        r = Math.floor(e * window.devicePixelRatio), n = Math.floor(t * window.devicePixelRatio);
...
class ba extends ma {
  constructor(e, t) {
    super(e), this.needsRecalculation = !1, this.recalculationCount = 0, this.latestPush = 0, this.bubbles = [], this.bubblesDict = {}, this.pointerX = -1, this.pointerY = -1, this.hoveredBubble = null, this.draggedBubble = null, this.possibleSelectedBubble = null, this.timePointerDown = 0, this.timeLastWakeUp = Date.now(), this.selectedCurrencyId = null, this.renderFavoriteBorder = !0, this.eventSelect = new _r, this.eventResize.register((() => {
      ...
      const t = Date.now() - this.timeLastWakeUp, r = ta(Math.round(t / 150 - 20), 0, 80);
      r > 0 && !xr.isEmbedded ? window.setTimeout((() => this.requestFrame()), r) : this.requestFrame()
    })), this.properties = t, e.addEventListener("pointerdown", (e => this.handlePointerDown(e)), {passive: !1}), e.addEventListener("pointermove", (e => this.handlePointerMove(e))), e.addEventListener("touchmove", (e => this.handleTouchMove(e)), {passive: !1}), e.addEventListener("pointerup", (e => this.handlePointerUp(e))), e.addEventListener("pointercancel", (() => this.handlePointerCancel()))
  }
  ...
  getFocusedBubble() {
    for (let e = this.bubbles.length - 1; e >= 0; e--) {
      ...
      if (t.visible) {
        const e = t.posX - this.pointerX, r = t.posY - this.pointerY, n = e * e + r * r, i = t.radius + Mt.bubbleHitbox;
        if (i * i >= n) return t
      }
    }
    return null
  ...
  launchExplosion() {
    for (const e of this.bubbles) {
      const t = e.posX - this.pointerX, r = e.posY - this.pointerY, n = Math.max(1, Math.sqrt(t * t + r * r)),
        i = 5e3 / n / n;
  ...
  update(e) {
    const t = Math.pow(.5, e), r = .001 * Math.min(this.width, this.height);
    ...
    for (let n = 0; n < this.bubbles.length; n++) {
      ...
      if (e.visible) {
        for (let t = n + 1; t < this.bubbles.length; t++) {
          ...
          const n = e.posX - r.posX, i = e.posY - r.posY, o = Math.max(1, Math.sqrt(n * n + i * i)),
            a = e.radius + r.radius;
          if (o < a) {
            const t = 6 / o, l = n * t, s = i * t, c = 1 - e.radius / a, u = r.radius / a - 1;
    ...
    if (this.draggedBubble) {
      const e = this.pointerX - this.draggedBubble.posX, t = this.pointerY - this.draggedBubble.posY,
  ...
  render() {
    this.clear();
    let e = null;
    for (const t of this.bubbles) if (t.renderFavoriteBorder = this.renderFavoriteBorder, t.visible) {
    ...
    if (this.draggedBubble ? this.draggedBubble !== e && (this.draggedBubble.render(this.context), this.renderBubbleBorder(this.draggedBubble, "white", 1)) : this.hoveredBubble && this.renderBubbleBorder(this.hoveredBubble, "white", 1), e) {
      ...
      const t = .5 * Math.sin(.008 * Date.now()) + .5, r = t + 2,
  ...
  recalculcate() {
    ...
    const {size: e, color: t, colors: r, period: n, content: i, baseCurrency: o} = this.properties,
    ...
    const c = this.width * this.height, u = 0 === l ? 0 : c / l * .6;
    for (const d of this.bubbles) {
      const e = Math.sqrt(d.size * u / Math.PI);
      d.setRadius(e, a);
      const l = oa(d.currency, t, n);
      d.setColor(na(l, r, s)), d.setContent(aa(d.currency, i, n, o)), d.posX = ta(d.posX, e, this.width - e), d.posY = ta(d.posY, e, this.height - e)
    }
  ...
  pushCurrencies(e) {
    ...
    for (const t of e) {
      ...
      r ? r.currency = t : (r = new va(t), r.posX = Math.random() * this.width, r.posY = Math.random() * this.height, this.bubbles.push(r), this.bubblesDict[e] = r), r.latestPush = this.latestPush
    }
    this.recalculcate()
  }
}
...
function wa() {
  ...
  const n = y((() => ({
    ...
    if (e) {
      const t = Oi() ? 0 : 52, r = Math.floor(Qr() - e.offsetTop - t);
      e.style.height = `${r}px`
    }
  }, o = () => {
    r && r.wakeUp()
  ...
  return _((() => {
    if (window.addEventListener("focus", o), window.addEventListener("resize", i), i(), "ios" === xr.env) for (let e = 0; e <= 1200; e += 400) window.setTimeout(i, e);
    t && (r = new ba(t, n()), r.eventSelect.register((e => ho(e))), r.start())
  })), k((() => {
...
function xa(e) {
  const t = () => Ut.findIndex((t => t.id === e.value.id)), r = () => {
    const r = t(), n = e.value, i = Ut[Math.max(r - 1, 0)];
    e.onClose(), Gt(i.id), Wt((e => e.filter((e => e.id !== n.id))))
  };
  return V(An, {
    class: "configuration-window", get onClose() {
      return e.onClose
    }, get header() {
      return [V(Un, {
        get value() {
      ...
      return [V(ln, {
        ...
        }, onChange: e => Wt(t(), "period", e), get options() {
          return Mt.periods.map((e => ({value: e, label: _a(e, Vt())})))
        }
      }), V(ln, {
        get label() {
          ...
          return e.value.size
        }, onChange: e => Wt(t(), "size", e), get options() {
          return [{value: "performance", label: Vt().performance}, {
            value: "rank-diff",
            label: ka(Vt())
          }, {value: "marketcap", label: Vt().marketcap}, {value: "volume", label: Vt().volume}]
        }
      }), V(ln, {
        get label() {
        ...
        }, onChange: e => Wt(t(), "content", e), get options() {
          return [{value: "performance", label: Vt().performance}, {
            value: "rank-diff",
            label: ka(Vt())
          }, {value: "marketcap", label: Vt().marketcap}, {value: "volume", label: Vt().volume}, {
            value: "price",
            label: Vt().price
          }, {value: "rank", label: Vt().rank}, {value: "name", label: Vt().currencyName}, {
            value: "dominance",
            label: Vt().dominance
          }]
        }
        ...
        }, onChange: e => Wt(t(), "color", e), get options() {
          return [{value: "performance", label: Vt().performance}, {
            value: "rank-diff",
            label: ka(Vt())
          }, {value: "neutral", label: Vt().neutral}]
        }
      })]
    }
  })
  ...
  return b((() => {
    ...
    n.addEventListener("drop", (t => {
      if (t.preventDefault(), t.currentTarget.classList.remove("drop"), t.dataTransfer) {
        !function (e, t) {
          const r = Ut.find((t => t.id === e)), n = Ut.find((e => e.id === t));
          r && n && Wt(Ut.map((i => i.id === e ? n : i.id === t ? r : i)))
    ...
    return "function" == typeof t ? oe(t, n) : t = n, te(n, "draggable", !0), ae(n, (() => {
      return t = e.configuration, r = Vt(), t.name && t.name.trim().length > 0 ? t.name : Ca(t, r);
      var t, r
    })), m((t => {
      var i = Er("tab", r() && "selected"), o = To(Ma(e.configuration), jt());
...
ee(["click"]);
var Ba = Q('<div class="bubble-chart-header flex-row"><div class="configuration-tabs scroll-container">');
...
function Sa() {
  ...
  const [t, r] = v(!1), n = e => {
    ...
    e && function (e, t, r) {
      const n = {left: t, top: r, behavior: "smooth"};
      try {
        e.scrollTo(n)
      } catch {
        try {
    ...
    const e = Ee("day", "performance");
    Wt((t => [...t, e])), Gt(e.id), r(!0)
  };
  return a = Ba(), l = a.firstChild, "function" == typeof e ? oe(e, l) : e = l, ae(l, V(j, {
    each: Ut,
    children: e => V(La, {configuration: e, onClick: n, onScrollTo: i})
  })), ae(a, V(Nr, {
    get active() {
      return t()
    }, onClick: () => r(!t()), get title() {
      return Vt().configuration_edit
    }, get children() {
      return V(Vn, {})
    }
  }), null), ae(a, V(Nr, {
    onClick: o, get title() {
      return Vt().configuration_add
    }, get children() {
      return V(Nn, {})
    }
  }), null), ae(a, V(ki, {
...
var Pa = Q("<main>"), Ta = Q("<div class=nav-filler>");
    ...
    get children() {
      return [V(W, {
        get when() {
          ...
          return [(e = Pa(), ae(e, V(Aa, {}), null), ae(e, V(ea, {}), null), e), V(uo, {})];
          var e
        }
      }), V(W, {
        get when() {
        ...
        get when() {
          ...
          return [(e = Pa(), ae(e, V(bi, {})), e), V(uo, {}), Ta()];
          var e
        }
      })]
    }
...
class Fa extends ma {
  ...
  drawPointOnChart(e, t, r, n) {
    const {context: i, width: o, height: a} = this, {x: l, y: s} = t, c = window.devicePixelRatio, u = .5 * o,
      d = .5 * a, h = po(e, r);
  ...
  render() {
    const {quotes: e, baseCurrency: t, period: r, context: n, width: i, height: o, pointerX: a} = this,
    ...
    const d = u - c;
    let h = 0;
    const p = {x: 0, y: 0}, g = {x: 0, y: 0};
    let f = null, v = null;
    n.beginPath();
    for (const _ of e) {
      const e = _.p, t = (.8 - .7 * ((e - c) / d)) * o;
    ...
    const y = To(1, this.colors), w = To(-1, this.colors);
    if (this.drawPointOnChart(c, p, t, w), this.drawPointOnChart(u, g, t, y), f && v) {
      const {p: e, t: a} = v, s = po(e, t);
      let c = 0;
      try {
      ...
      c = c || 150;
      const u = 6 * l, d = 4 * l, h = c + 2 * u, p = b + 2 * d, g = ta(f.x - h / 2, 0, i - h), m = 0;
      ...
      if ("year" === r) w = y.toLocaleDateString(); else try {
        w = y.toLocaleString(void 0, {dateStyle: "medium", timeStyle: "short"})
      } catch {
      }
...
function Ea(e) {
  ...
  const [i, o] = v(null), a = () => {
    ...
    mr(`data/charts/${e.period}/${e.currency.id}/${Et().id.toUpperCase()}.json`, n).then(o).catch((() => {
    }))
  };
  return _((() => {
    ...
    r && (r.quotes = i(), r.quotes && "hour" !== e.period && (r.quotes = [...r.quotes, {
      p: e.currency.price,
      t: Date.now() / 1e3
    }]), r.colors = jt(), r.baseCurrency = Et(), r.period = e.period, r.requestFrame())
  })), s = Ha(), c = s.firstChild, u = c.nextSibling, d = u.nextSibling, "function" == typeof t ? oe(t, c) : t = c, ae(d, (() => _a(e.period, Vt()))), m((t => {
    var r = Er("price-chart", i() && "loaded"), n = e.currency.image, o = e.currency.name;
    return r !== t.e && re(s, t.e = r), n !== t.t && te(u, "src", t.t = n), o !== t.a && te(u, "alt", t.a = o), t
  }), {e: void 0, t: void 0, a: void 0}), s;
  var s, c, u, d
}

var Da = Q('<span class="bubble-window-price flex-row gap-m"><span class=color-secondary>');
const Na = 1;

function Oa(e) {
  const [t, r] = v(Na.toString()), n = () => {
    let r = function (e, t) {
      try {
  ...
  return i = Da(), o = i.firstChild, ae(i, V(Un, {
    get value() {
      return Na.toString()
    }, iconComponent: Vn, placeholder: "Amount", type: "number", onInput: r
  }), o), ae(o, (() => `${e.currency.symbol} =`)), ae(i, V(Eo, {
    format: "currency", get children() {
      return n()
    }
  }), null), i;
  var i, o
...
var Va = Q('<div class=bubble-window-details><div class="flex-column gap-s grow"><span class=text-secondary></span></div><div class="flex-column gap-s grow"><span class=text-secondary></span></div><div class="flex-column gap-s grow"><span class=text-secondary>'),
  Ra = Q("<div class=bubble-window-performance>"), ja = Q("<div><span class=text-secondary></span><span>");
...
function Ua(e) {
  ...
  return b((() => n(t()))), V(An, {
    class: "bubble-window", get onClose() {
      return e.onClose
    }, get header() {
      return [V(wo, {
        get currency() {
      ...
      return V(I, {
        keyed: !0, get when() {
          ...
          return [V(Po, {
          ...
          }), (i = Va(), o = i.firstChild, a = o.firstChild, l = o.nextSibling, s = l.firstChild, c = l.nextSibling, u = c.firstChild, ae(a, (() => Vt().rank)), ae(o, V(Ro, {
            animate: !0,
            get currency() {
              return e.value
            },
          ...
          }), null), ae(s, (() => Vt().marketcap)), ae(l, V(Eo, {
            format: "currency", get children() {
              return e.value.marketcap
            }
          }), null), ae(u, (() => Vt().volume)), ae(c, V(Eo, {
            format: "currency", get children() {
            ...
            each: Ia, children: t => {
              ...
              return o = ja(), a = o.firstChild, l = a.nextSibling, o.$$click = () => n(t), ae(a, (() => _a(t, Vt()))), ae(l, (() => go(i(), !0))), m((e => {
                var n = Er("flex-column grow", t === r() && "selected"), a = (() => {
                  const e = To(i(), jt()), t = $o(i(), jt());
...
ee(["click"]);
var Wa = Q('<svg viewBox="0 0 24 24"><circle cx=7.2 cy=14.4 r=3.2></circle><circle cx=14.8 cy=18 r=2></circle><circle cx=15.2 cy=8.8 r=4.8>');
const Xa = e => {
...
function qa() {
  ...
  return t = Ga(), r = t.firstChild, n = r.nextSibling, ae(r, V(Cn, {})), ae(n, V(on, {
    get active() {
      return "bubbles" === ir()
    }, onClick: () => e("bubbles"), get children() {
      return V(Xa, {})
    }
  }), null), ae(n, V(on, {
    get active() {
      return "list" === ir()
    }, onClick: () => e("list"), get children() {
      return V(Ui, {})
    }
  }), null), ae(n, V(on, {
    get active() {
      return "settings" === ir()
    }, onClick: () => e("settings"), get children() {
      return V(jr, {})
    }
  }), null), t;
  var t, r, n
...
var Ka = Q("<div class=status><img class=logo width=64 height=64><span>"),
  ...
  Qa = Q('<div class=status><div class="flex-column color-secondary"><span></span></div><span>');
    ...
    get children() {
      return [V(W, {
        get when() {
          ...
          var e = Ka(), t = e.firstChild;
          return ae(t.nextSibling, (() => Vt().loading)), m((e => {
            var r = Mt.logo, n = Mt.app, i = `Logo of ${Mt.app}`;
            ...
            get when() {
              ...
              return V(I, {
                keyed: !0, get when() {
                  return function () {
                    const e = Nt();
                    if ("list" === e.type) return wn().find((t => {
                      return r = e.list, n = t.filter.list, r.length === n.length && r.every(((e, t) => e === n[t]));
                      var r, n
                    }))
                  }()
                }, children: e => {
                  return t = Qa(), r = t.firstChild, n = r.firstChild, i = r.nextSibling, ae(r, V(e.iconComponent, {}), n), ae(n, (() => e.name)), ae(i, (() => Vt().empty_list)), t;
                  var t, r, n, i
                }
              })
            }
...
function rl() {
  return b((() => At.save(At.generateSave()))), b((() => wr())), b((() => {
    const e = Ma(Pi()), t = To(e, jt()), r = $o(e, jt());
    ...
    get value() {
      return Ti()
    }, component: Ua, onClose: () => lr(null)
  })]
}

ee(["click"]);
const nl = window.matchMedia("(display-mode: standalone)").matches, il = document.getElementById("app"),
  ol = nl ? "pwa" : il.className;
xr.create(ol), window.addEventListener("load", (() => {
  !function (e, t, r, n = {}) {
    let i;
    f((n => {
      i = n, t === document ? e() : ae(t, e(), t.firstChild ? null : void 0, r)
    }), n.owner)
  }((() => V(rl, {})), il), "ios" !== xr.env && "serviceWorker" in navigator && navigator.serviceWorker.register("./sw.js")
}));
