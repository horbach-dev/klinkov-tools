...
const q = new Set(["beforeinput", "click", "dblclick", "contextmenu", "focusin", "focusout", "input", "keydown", "keyup", "mouseout", "mouseover", "mouseup", "pointerdown", "pointermove", "pointerout", "pointerover", "pointerup", "touchend", "touchmove", "touchstart"]),
  K = {
  ...
  return [we(r), function (...e) {
    S((() => {
      n && 1 === e.length ? function (e, t) {
        // console.log(123, "function" == typeof t && (t = t(e)), t = ke(t), Array.isArray(t))
...
document.addEventListener('toggle-period', ({detail}) => {
  console.log(detail)
  if (detail.mode === 0) {
    const e = De(qwe[detail.value], "performance");
    Xt((t => [...t, e])), Yt(e.id)
  }
  if (detail.mode === 1) {
    const e = De(qwe[detail.value], "volume");
    Xt((t => [...t, e])), Yt(e.id)
  }
  ...
  const res = data.map(currency => {
    return {
      ...
      "volume": {
        ...
        "day": currency.quotes[2].volume24h,
        "week": currency.quotes[2].volume7d,
        "month": currency.quotes[2].volume30d,
...
const getData = async (count = 100, qqqqqqqwwwwww=false) => {
...
function wr(count = 100, newData = false) {
  yr && (yr.abort(), yr = null);
  let e = null;
  try {
